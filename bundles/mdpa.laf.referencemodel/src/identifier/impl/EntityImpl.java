...
public abstract class EntityImpl extends IdentifierImpl implements Entity
{
	...
	public void setEntityName(String newEntityName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdentifierPackage.ENTITY__ENTITY_NAME, oldEntityName, entityName));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == NamedElement.class)
		{
			...
			{
				case IdentifierPackage.ENTITY__ENTITY_NAME: return IdentifierPackage.NAMED_ELEMENT__ENTITY_NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == NamedElement.class)
		{
			...
			{
				case IdentifierPackage.NAMED_ELEMENT__ENTITY_NAME: return IdentifierPackage.ENTITY__ENTITY_NAME;
				default: return -1;
			}
		}
